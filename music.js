...
const killersSpisok = document.querySelector(".music_spisok");
if (killersSpisok) {
  killersSpisok.addEventListener("click", function (e) {
    ...
    if (e.target.classList.contains("lms-show")) {
      document.querySelector(".lms_hide").style.display = "block";
    }
    if (e.target.classList.contains("chase-show")) {
      document.querySelector(".chase_hide").style.display = "block";
    }
  });
}